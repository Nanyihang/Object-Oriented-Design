...
namespace CodeAnalysis
{
  ...
  void TreeWalk(element* pItem, bool details = false)
  {
    ...
    ++indentLevel;
	/*
	std::cout << std::endl << "type_ : " << pItem->type_ << std::endl;
	std::cout << std::endl << "Startline :" << pItem->startLineCount_ << std::endl;
	std::cout << std::endl << "Endline : " << pItem->endLineCount_ << std::endl;
	*/
